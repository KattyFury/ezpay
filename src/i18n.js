...
const EN = {
  ...
  'Ví chưa được tạo — nạp USDC để kích hoạt': 'Wallet not created — deposit USDC to activate',
  'Danh bạ': 'Contacts',
  'Quét QR': 'Scan QR',
...
const ZH = {
  ...
  'Đang tải...': '加载中...', 'Chưa có token': '暂无代币',
  'Ví chưa được tạo — nạp USDC để kích hoạt': '钱包尚未创建 — 充值 USDC 以激活',
